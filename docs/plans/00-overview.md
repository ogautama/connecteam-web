...
| 16 | DISC lead visibility (hierarchy-scoped `/member/leads`) | 04, 06, 15 | [16-disc-lead-visibility.md](16-disc-lead-visibility.md) | ✅ Done — [PR #43](https://github.com/ogautama/connecteam-web/pull/43); DISC unlisted from the public site with [PR #41](https://github.com/ogautama/connecteam-web/pull/41) |
